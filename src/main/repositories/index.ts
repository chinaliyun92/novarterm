...
import { TerminalTriggerRepository } from './terminal-trigger-repository';
...
export interface RepositoryRegistry {
  ...
  terminalTriggers: TerminalTriggerRepository;
}
...
export function createRepositoryRegistry(db: Database.Database): RepositoryRegistry {
  return {
    ...
    terminalTriggers: new TerminalTriggerRepository(db),
  };
}
...
export { TerminalTriggerRepository } from './terminal-trigger-repository';
