...
const MIGRATION_MARKER_KEY = 'uiLanguageMigrated.v1'
...
const messages: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    'settings.server.field.passphrase': 'Passphrase',
    'settings.server.field.defaultDirectory': 'Default Directory',
    'settings.server.field.authType': 'Authentication',
    'settings.server.authType.password': 'Password',
    'settings.server.authType.privateKey': 'Private key',
    ...
    'settings.update.readyTitle': 'Ready to Restart',
    'settings.update.availableDescription': 'A new version has been found. Start downloading now?',
    'settings.update.readyDescription': 'The new version has been downloaded. Restart now to install it.',
    'settings.update.currentVersion': 'Current version',
    'settings.update.latestVersion': 'Latest version',
    'settings.update.releaseTag': 'Release tag',
    'settings.update.updateNow': 'Update Now',
    'settings.update.restartNow': 'Restart Now',
    'settings.update.downloadingAction': 'Downloading...',
    'settings.update.downloadingStatus': 'Downloading update...',
    'settings.update.downloadedStatus': 'Update downloaded. Restart to install.',
    'settings.update.downloadFailed': 'Failed to download the update.',
    'settings.update.restartFailed': 'Failed to restart and install the update.',
    'settings.update.progressKnown': '{transferred} / {total}',
    'settings.update.progressUnknown': '{transferred} transferred',
    ...
    'terminal.update.restartLabel': 'Restart to Update',
    'terminal.update.restartTitle': 'Install the update and restart',
    'terminal.update.restartAria': 'Restart to install update',
    ...
    'terminal.aiBar.modelSelectEmpty': 'No model configured',
    ...
    'terminal.aiBar.error.notConfigured': 'Please configure your AI API Key in Settings first.',
    'terminal.aiBar.error.notConfiguredHint': 'No AI model configured. Add your API Key in Settings to continue.',
    'terminal.aiBar.error.configureNow': 'Configure now',
    ...
    'terminal.aiBar.inputDisabledPlaceholder': 'Configure an AI model in Settings to start chatting...',
    ...
    'file.inspector.confirm.saveAsOverwrite': 'Path already exists: {path}. Overwrite?',
    ...
    'file.remoteState.error.pathExists': 'Path already exists: {path}',
  ...
  'zh-CN': {
    ...
    'settings.server.field.authType': '认证方式',
    'settings.server.authType.password': '密码',
    'settings.server.authType.privateKey': '私钥',
    ...
    'settings.update.readyTitle': '更新已就绪',
    'settings.update.availableDescription': '检测到新版本，是否立即开始下载？',
    'settings.update.readyDescription': '新版本已经下载完成，点击「立即重启」后开始安装。',
    'settings.update.currentVersion': '当前版本',
    'settings.update.latestVersion': '最新版本',
    'settings.update.releaseTag': '发布标签',
    'settings.update.updateNow': '立即更新',
    'settings.update.restartNow': '立即重启',
    'settings.update.downloadingAction': '下载中...',
    'settings.update.downloadingStatus': '正在下载更新...',
    'settings.update.downloadedStatus': '更新已下载完成，等待重启安装。',
    'settings.update.downloadFailed': '下载更新失败。',
    'settings.update.restartFailed': '重启安装失败。',
    'settings.update.progressKnown': '已下载 {transferred} / {total}',
    'settings.update.progressUnknown': '已下载 {transferred}',
    ...
    'terminal.update.restartLabel': '重启更新',
    'terminal.update.restartTitle': '安装更新并重启',
    'terminal.update.restartAria': '重启安装更新',
    'terminal.pane.label.local': 'local',
    'terminal.pane.label.remote': 'remote',
    ...
    'terminal.aiBar.modelSelectEmpty': '尚未配置模型',
    ...
    'terminal.aiBar.error.notConfigured': '请先在设置中配置你的 AI API Key。',
    'terminal.aiBar.error.notConfiguredHint': '尚未配置 AI 模型，请先在设置中添加 API Key。',
    'terminal.aiBar.error.configureNow': '去配置',
    ...
    'terminal.aiBar.inputDisabledPlaceholder': '请先在设置中配置 AI 模型后再使用...',
    ...
    'file.inspector.confirm.saveAsOverwrite': '路径已存在：{path}。是否覆盖？',
    ...
    'file.remoteState.error.pathExists': '路径已存在：{path}',
...
function hasStoredLanguageInLocalStorage(): boolean {
  if (typeof window === 'undefined') {
    return false
  }
...
async function readSettingMarker(api: SettingsApi, key: string): Promise<string | null> {
...
async function writeSettingMarker(api: SettingsApi, key: string, value: string): Promise<void> {
...
function createI18nState() {
  ...
  async function hydrateFromElectron(): Promise<void> {
    ...
    try {
      const migratedFlag = await readSettingMarker(api, MIGRATION_MARKER_KEY)
      const shouldMigrate = hasStoredLanguageInLocalStorage() && migratedFlag !== 'true'

      if (shouldMigrate) {
        await writeLanguageToElectron(api, language.value)
        await writeSettingMarker(api, MIGRATION_MARKER_KEY, 'true')
      }
