...
export const TERMINAL_IPC_CHANNELS = {
  ...
  saveCwd: "terminal:saveCwd",
  saveSnapshot: "terminal:saveSnapshot",
  prepareForQuitComplete: "terminal:prepareForQuitComplete",
  cleanPersistedLogs: "terminal:cleanPersistedLogs",
...
export const TERMINAL_IPC_EVENTS = {
  ...
  prepareForQuit: "terminal:prepareForQuit",
} as const;
...
export const TRIGGER_IPC_CHANNELS = {
  list: 'trigger:list',
  replaceAll: 'trigger:replaceAll',
} as const;

export type TriggerIPCChannel =
  (typeof TRIGGER_IPC_CHANNELS)[keyof typeof TRIGGER_IPC_CHANNELS];

export const UPDATE_IPC_CHANNELS = {
  check: 'update:check',
  getState: 'update:getState',
  download: 'update:download',
  restartToInstall: 'update:restartToInstall',
...
export type UpdateIPCEventChannel =
  (typeof UPDATE_IPC_EVENTS)[keyof typeof UPDATE_IPC_EVENTS];
